                            ...
                            <div class="card-body">
                             <div class="col-sm-12">
                                    <div class="col-sm-4"  style="float: left;">
                                         <a href="ngaydkonl.php"><input type="button"  class="btn btn-block btn-success" value="Tìm ngày đăng ký online"></a>
                                    </div>
                                    <div class="col-sm-4"  style="float: right;">
                                        <a href="loaimau.php"><input type="button"  class="btn btn-block btn-success" value="Tìm loại máu"></a>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form method="POST" class="form-horizontal form-material mx-2" enctype="multipart/form-data" >
                                        <?php
                                        include "../config.php";
                                            $sql= mysql_query("SELECT * FROM nguoihienmau join hosohienmau on hosohienmau.id_NHM= nguoihienmau.MSNHM WHERE thetichmauML!='NULL'");
                                            $i=0;
                                        ?>
