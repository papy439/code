                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Hồ sơ hiến máu</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <?php
                        if (isset($_REQUEST['ngaydkONLM']) and ($_REQUEST['ngaydkONLM']!="")) {
							$id= $_GET['ngaydkONLM'];
                                ...
                                $query = mysql_query("SELECT * FROM nguoihienmau LEFT JOIN hosohienmau on nguoihienmau.MSNHM = hosohienmau.id_NHM WHERE ngaydkONLM='$id'");
                                if (mysql_num_rows($query) == 0) {
                                    echo "Mã NHM này không tồn tại. Vui lòng kiểm tra lại. <a href='javascript: history.go(-1)'>Trở lại</a>";
                                    
                                }
                                $row = mysql_fetch_array($query);
                                if ($id != $row['ngaydkONLM']) {
                                    echo "Mã NHM không đúng. Vui lòng nhập lại. <a href='javascript: history.go(-1)'>Trở lại</a>";
                                    
                                }
                                $_SESSION['CCCD'] = $row['CCCD'];
                                $_SESSION['ngaydkONLM']= $id;
							include "../include/hshm.php";
							include "../include/hscbyt.php";
						}
						?>
