                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Thông tin người hiến máu</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                           ...
                                           <?php if (isset($_REQUEST['MSNHM']) and $_REQUEST['MSNHM']!="") {
                                                    include "../include/elseifttnhm.php";
                                            }

                                            else{ 
                                                    include "../include/elsettnhm.php";
                                             } ?>
