                                ...
                                <div class="table-responsive">
                                    <form method="POST" class="form-horizontal form-material mx-2" enctype="multipart/form-data" >
                                        <table class="table user-table" >
                                            ...
                                            <?php
                                                $queryTong ="SELECT sum(thetichmauML) as thetichmau, Count(thetichmauML)as solan
                                                    FROM nguoihienmau LEFT JOIN hosohienmau on nguoihienmau.MSNHM = hosohienmau.id_NHM  WHERE ngaydkONLM = '$ngayonl'";
                                                    $sql=mysql_query($queryTong);
