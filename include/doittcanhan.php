...
<ul style="padding-right: 650px;float: right;padding-top: 10px;font-size: 20px; font-size: 30px;color: #0000FF;font-family:  Palatino Linotype;">BỆNH VIỆN <br>TRUYỀN MÁU HUYẾT HỌC</ul>
	...
	<div style="height: 70px;width: auto;font-size: 20px;font-family: Palatino Linotype;background-color: #00008B;padding-top: 10px;">
		...
		<a href="doittcanhan.php" style="float: right;color: white;padding-right: 20px;">
			
			<ul style="float: right;padding-right: 10px;color: white;"><?php echo "Chào Bạn " . $_SESSION['HOTEN'];?> 
		...
		<a href="loginsusses.php"  style="float: right;color: white;"><button type="button" class="btn btn-warning">Trở Về
	...
	<div style="height: 800px;width: 100%;padding-top: 30px;text-align: center; background-color:rgba(0, 155, 255, 0.1);">
		...
		$pat="../img/qr/";
		$query= mysql_query("SELECT * from nguoihienmau where SODT='$user'");
		while ($row = mysql_fetch_array($query)) { ?>


		<form action="luu-thongtincanhan.php" method="post">
			<div style="float: left;padding-left: 200px;padding-top: 80px;padding-right: 100px;"><img src="<?php echo $pat.$row['MSNHM'].'.png' ?>" alt="" style="height: 300px;width: 300px; border-radius: 20px;"></div>
		<table border="0"style="height: 200px;width: 800px;margin-right: 200px;margin-left: 200px;margin-top: 20px;">

			<tr >
				<td colspan="2"style="font-weight: bold;text-align: center; font-size: 24px;height: 80px;color: red;">	THÔNG TIN CỦA NGƯỜI HIẾN MÁU</td>
					<td></td>
					
				</tr>
				<tr style="text-align: left;">
					<td>Họ tên người hiến máu :</td>
					<td><input type="text" name="tHOTEN" id="tHOTEN" class="form-control" value="<?php echo $_SESSION['HOTEN'] ?>"></td>
					
				</tr>
				<tr>
					<td  style="text-align: left;">Ngày sinh :</td>
					<td><input type="text" name="tNGAYSINH" id="tNGAYSINH" class="form-control" value=" <?php echo $row['NGAYSINH'] ?> " ></td>
					
				</tr>
				<tr>
					<td  style="text-align: left;">Nghề nghiệp :</td>
					<td><input type="text" name="tNGHENGHIEP" id="tNGHENGIEP" class="form-control" value="<?php echo $row['NGHENGHIEP'] ?>"></td>
				...
				<tr>
					...
					<td > 
						...
						<input name="rGIOITINH" id="rGIOITINH" value="0" type="radio"  >Nam  
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gender-male" viewBox="0 0 16 16" >
						  <path fill-rule="evenodd" d="M9.5 2a.5.5 0 0 1 0-1h5a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-1 0V2.707L9.871 6.836a5 5 0 1 1-.707-.707L13.293 2H9.5zM6 6a4 4 0 1 0 0 8 4 4 0 0 0 0-8z"/>
						</svg> 
					<input name="rGIOITINH"  id="rGIOITINH" value="1" type="radio" checked>Nữ  
				...
				<td > 
						...
						<input name="rGIOITINH" id="rGIOITINH" value="0" type="radio" checked >Nam  
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gender-male" viewBox="0 0 16 16" >
						  <path fill-rule="evenodd" d="M9.5 2a.5.5 0 0 1 0-1h5a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-1 0V2.707L9.871 6.836a5 5 0 1 1-.707-.707L13.293 2H9.5zM6 6a4 4 0 1 0 0 8 4 4 0 0 0 0-8z"/>
						</svg> 
					<input name="rGIOITINH"  id="rGIOITINH" value="1" type="radio" >Nữ  
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gender-female" viewBox="0 0 16 16">
  					<path fill-rule="evenodd" d="M8 1a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM3 5a5 5 0 1 1 5.5 4.975V12h2a.5.5 0 0 1 0 1h-2v2.5a.5.5 0 0 1-1 0V13h-2a.5.5 0 0 1 0-1h2V9.975A5 5 0 0 1 3 5z"/>
						</svg></td>
				<?php } ?>
				...
				<tr>
					<td  style="text-align: left;">Địa chỉ liên lạc :</td>
					<td><input type="text" name="tDIACHI" id="tDIACHI" class="form-control" value="<?php echo $row['DIACHI'] ?>"></td>
					
				</tr>
				<tr>
					<td  style="text-align: left;">CCCD/CMND :</td>
					<td><input type="text" name="tCCCD" id="tCCCD" class="form-control" value="<?php echo $row['CCCD'] ?>"></td>
					
				</tr>
				
				<tr>
					<td  style="text-align: left;">Email :</td>
					<td><input type="text" name="tEMAIL" id="tEMAIL" class="form-control" value="<?php echo $row['EMAIL'] ?>" ></td>
					
			</tr>
			<tr>
					<td  style="text-align: left;">Loại máu :</td>
					<td><input type="text" name="tEMAIL" id="tEMAIL" class="form-control" readonly value="<?php if(isset($row['loaimau'])) echo $row['loaimau']; else echo "...";?>" ></td>
					
			</tr>
			<tr>
					<td  style="text-align: left;">Bệnh nền:</td>
					<td><input type="text" name="tEMAIL" id="tEMAIL" class="form-control" readonly value="<?php if(isset($row['benhnen'])) echo $row['benhnen']; else echo "Không"; ?>" ></td>
					
			</tr>
			<tr>
				<td colspan="2"><ul style="padding-top: 20px;">
						<a href="luu-thongtincanhan.php"><input type="submit" name="btn-save-tttkcn" style="border-radius: 20px;height: 50px;width: 250px;font-weight: bolder;font-size: 20px;font-family: Book Antiqua;text-align: center; "class="btn-success" value="Cập Nhập">
