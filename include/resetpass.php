...
<body>
	...
	<div style="height: 70px;width: auto;font-size: 20px;font-family: Palatino Linotype;background-color: #00008B;padding-top: 10px;">
		...
		<a href="../index.php"  style="float: right;color: white;padding-right: 30px"><button type="button" class="btn btn-warning">Trở Về
	...
	<table border="1" style="height: 200px;width: 500px;margin-left: 500px;margin-right: 100px;margin-top: 20px;">
		<tr>
			<td style="font-family: Palatino Linotype;font-weight: bold;">Số điện thoại :</td>
			<td colspan="3"><input type="text"class="form-control" name="txtsdt" id="txtsodt" placeholder="Số điện thoại" placeholder="Số điện thoại"></td>
			
		</tr>

		<tr>
			<td style="font-family: Palatino Linotype;font-weight: bold;">Địa chỉ email:</td>
			<td colspan="3"><input type="text"class="form-control" name="txtemail" id="txtemail" placeholder="abc123@gmail.com"placeholder="abc123@gmail.com" ></td>
		
		</tr>
		<tr>
			<td colspan="2"></td>
			<td colspan="2">
				<a href="sendmail.php" style="text-align: center;padding-right: 20px;padding-left: 40px;" ><input type="submit" name="btn-send" class="btn btn-primary" value="Gửi thông tin">
