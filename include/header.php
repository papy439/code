<div style="height: 150px;width: auto;background-image:url('img/background.jpg');">
		...
		<ul style="padding-right: 50px;float: right;padding-top: 50px;font-size: 20px;">
			<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="516 516">
