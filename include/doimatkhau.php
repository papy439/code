...
<head>
  ...
  <title>BV TRUYỀN MÁU HUYẾT HỌC - Đổi Mật Khẩu</title>
...
<body>
	...
	<form action="doimatkhau2.php" method="post">
	<table border="1" style="height: 200px;width: 600px;margin-left: 500px;margin-right: 100px;margin-top: 20px;font-family: Palatino Linotype;font-weight: bold;">
		...
		<tr>
			...
			<td><input type="text"class="form-control" name="pwd" id="username" placeholder="mật khẩu cũ"></td>
		</tr>

		<tr>
			<td>Nhập mật khẩu mới :</td>
			<td><input type="password"class="form-control" name="newpwd" id="password"placeholder="mật khẩu mới" ></td>
		</tr>
		<tr>
			<td>Nhập lại mật khẩu mới :</td>
			<td><input type="password"class="form-control" name="renewpwd" id="password" placeholder="nhập lại mật khẩu mới"></td>
		</tr>
		<tr>
			<td colspan="2"><a href="doimatkhau2.php.php" >
				<input type="submit" style="height: 50px;width: 150px;" 
				class="btn btn-success" value="Xác Nhận" name="btn-xacnhan"> 
					</a>
			</td>
		</tr>
