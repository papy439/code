...
<head>
  ...
  <title>BV TRUYỀN MÁU HUYẾT HỌC - Phản Hồi </title>
...
<body>
	...
	<div style="height: 70px;width: auto;font-size: 20px;font-family: Palatino Linotype;background-color: #00008B;padding-top: 10px;">
		...
		<a href="../thucamon.php"class=" doimau"style="padding-left: 30px;color: white;">
		  ...
		  <path d="M8.941.435a2 2 0 0 0-1.882 0l-6 3.2A2 2 0 0 0 0 5.4v.313l6.709 3.933L8 8.928l1.291.717L16 5.715V5.4a2 2 0 0 0-1.059-1.765l-6-3.2zM16 6.873l-5.693 3.337L16 13.372v-6.5zm-.059 7.611L8 10.072.059 14.484A2 2 0 0 0 2 16h12a2 2 0 0 0 1.941-1.516zM0 13.373l5.693-3.163L0 6.873v6.5z"/>
				...
				Thư cảm ơn</a>
		<a href="../loiich.php" class=" disabled doimau" tabindex="-1" style="padding-left: 30px;color: white;">
		...
		<a href="loginsusses.php"  style="float: right;color: white;padding-right: 30px"><button type="button" class="btn btn-warning">Trở Về
	...
	<?php 
		...
		<form method="post" action="luu-phanhoi.php">
			<div style="height: auto;width: 100%;padding-top: 30px;text-align: center; background-color:rgba(0, 155, 255, 0.1);">
			<table border="1" style="height: 200px;width: 600px;margin-left: 500px;margin-right: 100px;margin-top: 20px;font-family: Palatino Linotype;font-weight: bold;">

				<tr>
					<td>Nhập ý kiến :</td>
					<td><textarea class="form-control" name="tNOIDUNG" rows="3" required></textarea></td>
					
				</tr>
				<tr>
					<td colspan="2"><a href="luu-phanhoi.php" ><input type="submit" class="btn btn-success" name="btn-xacnhan"id="btn-xacnhan" value="Gửi"style="height: 50px;width: 150px;">			
					</td>
				</tr>
				<tr>
			</table>
	...
	<div style="height: auto;width: 100%;padding-top: 30px;text-align: center; background-color:rgba(0, 155, 255, 0.1);">
	<table border="1" style="height: 80px;width: 1300px;margin-left: 100px;margin-right: 200px;margin-top: 20px;margin-bottom: 20px;font-family: Palatino Linotype;font-weight: bold;">

		<tr style="font-weight: bold;color: red;font-family: Palatino Linotype;font-size: 20px;">
			<td>STT</td>
			<td>Ngày phản hồi ý kiến</td>
			<td>Ý kiến cá nhân</td>
			<td>Nội dung của bác sĩ</td>
			<td>Tên bác sĩ</td>
		...
		include "../ketnoi.php";
		$user=$_SESSION['MSNHM'];
		$query= mysql_query("SELECT  * from ((thongtinphanhoi left join canboyte on thongtinphanhoi.id_CBYT=canboyte.MSCBYT)left join nguoihienmau on thongtinphanhoi.id_NHM=nguoihienmau.MSNHM) where id_NHM='$user'");
		$i=0;
		...
		<tr >
			...
			echo $i;
			   ?></td>
			<td><?php if ($row['NGAYPH']!=NULL) {
							echo $row['NGAYPH'];
						}
						else 
				echo NULL; 
				 ?></td>
			<td><?php if ($row['NOIDUNG']!=NULL) {
							echo $row['NOIDUNG'];
						}
						else 
				echo NULL; 
				 ?></td>
			<td><?php if ($row['YKIEN']!=NULL) {
							echo $row['YKIEN'];
						}
						else 
				echo NULL; 
				 ?></td>
			<td><?php if ($row['TEN']!=NULL) {
							echo $row['TEN'];
						}
						else 
				echo NULL; 
