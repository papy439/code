	...
	<div class="input-group"style="background-color: white; text-align: justify; height: 100px; width: 800px; margin-left: 400px; margin-right: 400px; margin-top: 20px">
		<table border="2" style="height: 600px; width: auto;" >
			...
			<tr>
				...
				<td style="text-align: center;" ><input name="rtungHM" id="rtungHM" value="1"  type="radio" disabled ></td>
				<td style="text-align: center;"><input name="rtungHM" id="rtungHM" value="0"   type="radio" checked></td>
			</tr>
			<tr>
				...
				<td style="text-align: center;"><input name="rcacbenh" id="rcacbenh" value="1"  type="radio" required ></td>
			...
			<tr>
				...
				<div class="form-group pmd-textfield pmd-textfield-outline pmd-textfield-floating-label">
					<label for="tvacxincuthe12">
						Khác(cụ thể):
					</label>
					<input id="tvacxincuthe12" name="tvacxincuthe12" class="form-control" type="text" style="width: 550px;">
					<hr>
					</div>
				</td>
			...
			<tr>
				...
				<td style="text-align: center;"><input name="rtruyenmau" id="rtruyenmau" value="1"  type="radio" required ></td>
		...
		<a href="them-dangkyhienmau.php"><input type="submit" name="btn-save-dkn" style="border-radius: 20px;height: 50px;width: 250px;font-weight: bolder;font-size: 20px;font-family: Book Antiqua;text-align: center; "class="btn-success" value="Lưu Đăng ký">
		</a>
	</ul>
